...
var cart_products_sanitized  = cart_products.filter((value, index, self) => {
    return self.findIndex(v => v.product_id === value.product_id) === index && (value.product_stock_quantity > 0);
  })
